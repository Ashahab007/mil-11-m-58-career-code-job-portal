...
// 25.1 as we need to fetch the data from the applications server here we will do it a different way to fetch using function. When call that function it will take the email and set to the url and fetch the data of that email. Note: If u need the data of user.email in other section of website u can export it from here or u can make a folder name api under src folder and create another file applicationsPromise.js then export it from there. this is for large application.
